...
- When2Meet — meeting availability planning. SWP reports: [Week 3](src/when2meet/reports/week3/README.md) · [Week 2](src/when2meet/reports/week2/README.md). Hosted MVP: [pre.innohassle.ru/when2meet](https://pre.innohassle.ru/when2meet).
