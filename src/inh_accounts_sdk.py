...
class InNoHassleAccounts:
    ...
    async def update_key_set(self):
        logging.info("Updating key set for InNoHassle Accounts...")
        self.key_set = await self.get_key_set()
        logging.info("Key set updated successfully")
...
from src.config_root_schem import load_root_settings  # noqa: E402
