...
#align(center)[
  #text(size: 18pt, weight: "bold")[SWP Assignment 4]
  #v(0.4em)
...
- Week 4 report index: #link(links.at("public").at("week4_readme"))[README.md permalink]
...
#table(
  ...
  [Presentation slides],
    [#link(links.at("private").at("presentation_slides"))[Google Slides]],
  [Public customer review summary],
    [#link(links.at("public").at("customer_summary"))[customer-review-summary.md]],
...
- Sprint 2 milestone: #link(links.at("public").at("sprint_milestone"))[GitHub milestone]
...
= Customer review transcript (sanitized, Moodle-only)

Private instructor sharing: permitted. Not published in the public repository.
